...
export default function TenderlySimulationButton({ simulationArgs, shouldSimulate, setShouldSimulate, onSimulated }: { simulationArgs: TenderlySimulateArgs, shouldSimulate: boolean, setShouldSimulate: (shouldSimulate: boolean) => void, onSimulated?: (data: TenderlySimulationAPIResponse | undefined, shouldSimulate: boolean) => void }) {

  const { data, isLoading, error } = useTendelySimulate(simulationArgs, !!simulationArgs.to && shouldSimulate);
