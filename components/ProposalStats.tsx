...
export default function ProposalStats({proposal, isOverview = false}: 
            ...
            {proposal.scores_total > 0 && (
                <>
                    ...
                    <div className="px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6">
                        ...
                        <Tooltip
                            content={proposal.quorum>0 && `(${(proposal.scores_total*100/proposal.quorum).toFixed()}% of quorum)`}
                            trigger="hover"
                        >
                            <dd className="mt-1 text-3xl tracking-tight font-semibold text-gray-900">
                                {formatNumber(proposal.scores_total)}
                            </dd>
