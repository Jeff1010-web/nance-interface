  ...
  return (
    <div>
      ...
      <main>
        ...
        <div class="relative xs:px-6 sm:px-0 text-black font-medium gap-2 items-center w-full flex flex-col text-center">
          ...
          <div class="flex gap-8 items-center">
            <a href="https://twitter.com/juiceboxETH" target="_blank" rel="noreferrer">
              <svg class="w-6 h-8 fill-black hover:fill-gray-400 transition cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
