...
> = ({ space, address }) =>
  fetch(SUBGRAPH_URL, {
    ...
    .then((res) => res.json())
    .then((res) => res.data.delegations);

const SUBGRAPH_URL = `https://api.thegraph.com/subgraphs/id/${CONFIG.snapshot.subgraphId}`;
...
const SNAPSHOT_DELEGATE_REGISTRY_ADDRESS =
  "0x469788fE6E9E9681C6ebF3bF78e7Fd26Fc015446";
const SNAPSHOT_DELEGATE_REGISTRY_ABI = [
  {
    anonymous: false,
    inputs: [
      {
